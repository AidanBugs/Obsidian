...
WorkoutSession(<u>sessionID</u>, title, difficulty_level, trainerID, attendee's IDs, centerID)

Member(<u>memberID</u>, name, email, addressID)

Address(<u>addressID</u>, street, city, state, zip, emergency_phone, memberIDs)
