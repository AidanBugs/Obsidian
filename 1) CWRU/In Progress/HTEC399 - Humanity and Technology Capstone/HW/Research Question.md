# From Class:
My project studies AI benchmark performance in aggregate. 

Most people only look at the "best" performing models but I intervene by questioning what underlying factors influences "performance" using a mathod that makes a (performace/theoretical) cultural map of LLM's and asks if there are any emergent patterns.
