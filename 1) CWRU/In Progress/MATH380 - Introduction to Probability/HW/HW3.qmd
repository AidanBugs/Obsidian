...
2. There is a 0% false negative rate with the DNA matching (the perpetrator is guranteed to have their DNA match)

$P(K)=$ {Person is the Killer}

$P(M)=$ {Person has a DNA Match}

Thus using the above assumptions we get the following values for the probabilities:

$P(K)= \frac{1}{100,000}$, obtained from assumption 1.

$P(K^c)=1-P(K)= \frac{99,999}{100,000}$

$P(M|K)= 1$, obtained from assumption 2

$P(M|K^c)= \frac{1}{10,000}$, obtained from the problem statements
