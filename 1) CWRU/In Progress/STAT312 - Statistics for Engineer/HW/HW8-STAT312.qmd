...
> Reject $H_0$ because $z$ is in the reject region ($|z|>1.96$)

8. State the conclusion.

> At the $0.05$ significance level there is enough evidence to conclude that the population mean is not equal to $280$
