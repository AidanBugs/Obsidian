...
0.37 &\text{for} \quad x= 550 \\
0.47 &\text{for} \quad x= 650
\end{cases}
$$

## B

$\mu = E(X) = \sum\limits_{x}xf(x)=0.06*350+0.1*450+0.37*550+0.47*650=575$
$\sigma = \sqrt{VAR(X)}=\sqrt{E(X^2)-\mu^2}=$
$\sqrt{0.06*350^2+0.1*450^2+0.36*550^2+0.47*650^2-575^2}=\sqrt{7475}=86.458$
