...
Find a spanning tree $T^*$ that $\max \Pi_{e\inT} (1-p_e)$
...
This works because $\min_T \sum_{e\in T} w_e = \min_T - \sum_{e\in T} \ln(1-p_e) \equiv \max_T \sum_{e\inT} \ln(1-p_e)= \max_T \ln \Pi_{e\in T} (1-p_e)\equiv \max_T \Pi_{e\in T} (1-p_e)$
